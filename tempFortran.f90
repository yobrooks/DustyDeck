...
cend program dusty
        ...
        REAL(KIND = SELECTED_REAL_KIND(17,307)) function trig (i,j)
                REAL(KIND = SELECTED_REAL_KIND(17,307)) :: x, y, z
                pi = acos(-1.0)
                x = dble(i) - dble(j)
                y = dble(i) + dble(j)
        ...
        subroutine idcheck(N,check,AV,BV,ID)
                ...
                REAL(KIND = SELECTED_REAL_KIND(17,307)), TARGET :: AV(*), BV(*), ID(N,*)
                REAL(KIND = SELECTED_REAL_KIND(17,307)) :: l2, check, check2, a, b, c, d
